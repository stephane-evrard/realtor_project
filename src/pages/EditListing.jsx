...
export default function CreateListing() {
    ...
    async function onSubmit(e){
        ...
        if(+discountedPrice >= +regularPrice){
            setLoading(false)
            toast.error("Discounted Price need to be less that regular price")
            return;
        }
        if(images.length > 6){
            setLoading(false);
  ...
  return (
    <main className="max-w-md px-2 mx-auto">
        ...
        font-bold">Edit Listing</h1>
        <form onSubmit={onSubmit}>
            <p className="text-lg mt-6 font-semibold">Sell / Rent</p>
            <div className="flex">
                <button type="button" id="type" value="sale"
                onClick={onChange} className={`mr-3 px-7 py-3 font-medium
                text-sm uppercase shadow-md rounded hover:shadow-lg
                focus:shadow-lg active:shadow-lg transition duration-150
                ease-in-out w-full ${
            ...
            {!geolocationEnabled && (
                <div className="flex space-x-6 justify-start mb-6">
                    <div className="">
                        <p className="text-lg text-semibold">Latitude</p>
                    ...
                    <div className="">
                        <p className="text-lg text-semibold">Longitude</p>
            ...
            <div className="flex items-center mb-6">
                <div className="">
                    ...
                    <div className="flex w-full justify-center items-center space-x-6">
                        ...
                        onChange={onChange} min="50" max="40000000" required
                ...
                <div className="flex items-center mb-6">
                    <div className="">
                        ...
                        <div className="flex w-full justify-center items-center space-x-6">
                            ...
                            onChange={onChange} min="50" max="40000000" required={offer}
                            className="w-full px-4 py-2 text-xl text-gray-700 bg-white
                            border-gray-300 rounded transition duration-150 ease-in-out
                            focus:text-gray-700 focus:bg-white focus:border-slate-600
                            text-center"/>
