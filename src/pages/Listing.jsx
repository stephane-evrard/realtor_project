...
export default function Listing() {
    ...
    const [shareLinCopied, setShareLinkCopied] = useState(false);
  ...
  return <main>
    ...
    {shareLinCopied && (
        <p className="fixed top-[23%]
        right-[5%] font-semibold border-2
        border-gray-400 rounded-md bg-white z-10
        p-2">Link Copied</p>
    )}

    {/* 👉 Card that contain map */}
    ...
    lg:mx-auto p-4 rounded-lg shadow-lg bg-white lg:space-x-5">
        <div className="w-full">
            ...
            <ul className="flex items-center space-x-2 sm:space-x-10 text-sm
            font-semibold mb-6">
            ...
            {listing.userRef !== auth.currentUser?.uid && !contactLandlord && (
                <div className="mt-6">
                    ...
                    focus:bg-blue-700 focus:shadow-lg w-full
